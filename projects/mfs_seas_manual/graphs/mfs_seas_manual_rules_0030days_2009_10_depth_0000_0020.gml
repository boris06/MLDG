...
<!-- Created by igraph -->
  ...
  <graph id="G" edgedefault="directed">
    ...
    <edge source="n3" target="n3">
      <data key="supp">0.000702</data>
      <data key="conf">0.789677</data>
    </edge>
  </graph>
</graphml>
