...
<!-- Created by igraph -->
  ...
  <graph id="G" edgedefault="directed">
    ...
    <edge source="n4" target="n4">
      <data key="supp">0.000317</data>
      <data key="conf">0.95178</data>
    </edge>
