...
<!-- Created by igraph -->
  ...
  <graph id="G" edgedefault="directed">
    ...
    <edge source="n3" target="n3">
      <data key="supp">0.000713</data>
      <data key="conf">0.912916</data>
    </edge>
  </graph>
</graphml>
