...
<!-- Created by igraph -->
  ...
  <graph id="G" edgedefault="directed">
    ...
    <edge source="n3" target="n3">
      <data key="supp">0.000802</data>
      <data key="conf">0.896154</data>
    </edge>
  </graph>
</graphml>
